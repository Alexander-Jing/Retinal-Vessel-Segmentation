...
class EnhanceNetve(nn.Module):
    def __init__(self):
        super(EnhanceNetve, self).__init__()
        ...
        self.conv11 = self.conv_block(35,6)  # 32+3=35
        self.last_act = nn.PReLU()
        print("now using the EnhanceNetve with 6 channels output")
...
class SegNetvec(nn.Module):
    def __init__(self):
        super(SegNetvec, self).__init__()
        ...
        self.conv8 = self.conv_block(128,64)
        self.conv9 = self.conv_block(64,32)
        self.conv11 = self.conv_block(38,1)
        self.last_act = nn.PReLU()
        print("now using the SegNetvec with 6 channels input")
