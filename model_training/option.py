...
parser.add_argument('--data_test', type=str, default='DRIVET',
...
parser.add_argument('--model', default='CON_ENH',
                    help='model name')
...
# Loss specifications
parser.add_argument('--loss', type=str, default='1*BCE',
                    help='loss function configuration')
parser.add_argument('--skip_threshold', type=float, default='1e8',
                    help='skipping batch that has large error')

# Log specifications
parser.add_argument('--save', type=str, default='drive_k8',
                    help='file name to save')
parser.add_argument('--mark', type=str, default='_s8',
